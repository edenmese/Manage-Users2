...
//            break;
//        }else{
//            cout << "Only admin can reset password.";
//            break;
//        }
//    }
//    cout << "Enter password: ";
...
//    for (const User& admin : list) {
//           if ((input == admin.getEmail() || input == admin.getPhone()) && admin.getRole() == "admin") {
//               isAdmin = true;
//               break;
//           }
//       }
...
//    cin >> passwordInput;
//
//if (passwordInput == "forgot password") {
//    while (true){
//            forgotPassword();
//
//            cout << "Enter password: ";
...
//                    signedInUserIndex = -1; // Reset signedInUserIndex after signing out
                }
    }else {
